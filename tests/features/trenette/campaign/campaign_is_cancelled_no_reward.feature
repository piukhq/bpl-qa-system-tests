Feature: Bink BPL - Campaign is set to cancelled and reward is not allocated
  ...
  Background:
    ...
    And the trenette-stmp-campaign-1 campaign has reward rule with reward goal: 100, allocation window: None and reward cap: None
    And the trenette-stmp-campaign-2 campaign has reward rule with reward goal: 100, allocation window: None and reward cap: None
