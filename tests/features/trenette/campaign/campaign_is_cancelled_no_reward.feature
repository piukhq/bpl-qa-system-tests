Feature: Bink BPL - Campaign is set to cancelled and reward is not allocated
  ...
  Background:
    ...
    And the trenette-stmp-campaign-1 campaign has reward rule with reward goal: 100, reward slug: free-item, allocation window: 0 and reward cap: 0
    And the trenette-stmp-campaign-2 campaign has reward rule with reward goal: 100, reward slug: free-item-2, allocation window: 0 and reward cap: 0
