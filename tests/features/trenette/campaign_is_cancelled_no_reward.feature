Feature: Bink BPL - Campaign is set to cancelled and reward is not allocated
  ...
  Background:
    ...
    And the trenette-stmp-campaign-2 campaign has an STAMPS earn rule with a threshold of 500, an increment of 100, a multiplier of 1 and max amount of None
