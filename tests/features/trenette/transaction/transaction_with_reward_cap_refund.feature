...
Feature: Bink BPL - Transaction with a reward cap with allocation window
    ...
    Scenario: Pending rewards issued honouring TRC - 1x multiplier - Account holder A
        ...
        And the account holder has a single pending reward for trenette-acc-campaign with count of 2, total cost to user of 55000, value of 10000 and total value of 20000 with conversation date 1 day in future
        ...
        And the account holder balance shown for trenette-acc-campaign is 0
        And the account holder has a single pending reward for trenette-acc-campaign with count of 2, total cost to user of 35000, value of 10000 and total value of 20000 with conversation date 1 day in future
        And 2 pending rewards are available to the account holder

        When BPL receives a transaction for the account holder for the amount of -20000 pennies
        Then BPL responds with a HTTP 200 and refund_accepted message
        And the account holder balance shown for trenette-acc-campaign is 5000
        And the account holder has a single pending reward for trenette-acc-campaign with count of 1, total cost to user of 10000, value of 10000 and total value of 10000 with conversation date 1 day in future
        And 1 pending rewards are available to the account holder

    @bpl @trc @AC-4-5 @bpl-690
    Scenario: Pending rewards issued honouring TRC - Account holder B
        Given the trenette retailer exists
        And the retailer's trenette-acc-campaign ACCUMULATOR campaign starts 5 days ago and ends in a day and is ACTIVE
        And the trenette-acc-campaign campaign has an earn rule with a threshold of 0, an increment of 0, a multiplier of 1 and max amount of 0
        And the trenette-acc-campaign campaign has reward rule with reward goal: 10000, reward slug: free-item, allocation window: 1 and reward cap: 2
        ...
        And the account holder has a single pending reward for trenette-acc-campaign with count of 2, total cost to user of 25000, value of 10000 and total value of 20000 with conversation date 1 day in future
        And 2 pending rewards are available to the account holder
    ...
    Scenario: Pending rewards issued honouring TRC - Account holder C
        Given the trenette retailer exists
        And the retailer's trenette-acc-campaign ACCUMULATOR campaign starts 5 days ago and ends in a day and is ACTIVE
        And the trenette-acc-campaign campaign has an earn rule with a threshold of 0, an increment of 0, a multiplier of 1 and max amount of 0
        And the trenette-acc-campaign campaign has reward rule with reward goal: 10000, reward slug: free-item, allocation window: 1 and reward cap: 2
        ...
        Then BPL responds with a HTTP 200 and awarded message
        And the account holder balance shown for trenette-acc-campaign is 2500
        And the account holder has a single pending reward for trenette-acc-campaign with count of 2, total cost to user of 20000, value of 10000 and total value of 20000 with conversation date 1 day in future
        And 2 pending rewards are available to the account holder

    @bpl @trc @AC-7 @bpl-690
    Scenario:  Pending rewards issued honouring TRC - 2x multiplier - Account holder D
        Given the trenette retailer exists
        And the retailer's trenette-acc-campaign ACCUMULATOR campaign starts 5 days ago and ends in a day and is ACTIVE
        ...
        And the account holder has a single pending reward for trenette-acc-campaign with count of 2, total cost to user of 100000, value of 10000 and total value of 20000 with conversation date 1 day in future

        When BPL receives a transaction for the account holder for the amount of -25000 pennies
        Then BPL responds with a HTTP 200 and refund_accepted message
        And the account holder balance shown for trenette-acc-campaign is 0
        And the account holder has a single pending reward for trenette-acc-campaign with count of 2, total cost to user of 50000, value of 10000 and total value of 20000 with conversation date 1 day in future
        And 2 pending rewards are available to the account holder

    @bpl @trc @AC-8 @bpl-690
    Scenario:  Pending rewards issued honouring TRC - 2x multiplier - Account holder E coversation day 5 in future (Example: 4)
        Given the trenette retailer exists
        And the retailer's trenette-acc-campaign ACCUMULATOR campaign starts 5 days ago and ends in a day and is ACTIVE
        And the trenette-acc-campaign campaign has an earn rule with a threshold of 0, an increment of 0, a multiplier of 2 and max amount of 0
        ...
        Then BPL responds with a HTTP 200 and awarded message
        And the account holder balance shown for trenette-acc-campaign is 1000
        And the account holder has a single pending reward for trenette-acc-campaign with count of 2, total cost to user of 100000, value of 10000 and total value of 20000 with conversation date 5 day in future
...
#        And the account holder has a single pending reward for trenette-acc-campaign with count of 2, total cost to user of 50000, value of 10000 and total value of 20000 with conversation date 5 day in future
    ...
    Scenario:  Pending rewards issued honouring TRC - 1x multiplier - Account holder f (example-3)
        Given the trenette retailer exists
        And the retailer's trenette-acc-campaign ACCUMULATOR campaign starts 5 days ago and ends in a day and is ACTIVE
        And the trenette-acc-campaign campaign has an earn rule with a threshold of 0, an increment of 0, a multiplier of 1 and max amount of 0
        And the trenette-acc-campaign campaign has reward rule with reward goal: 10000, reward slug: free-item, allocation window: 5 and reward cap: 2
        ...
        Then BPL responds with a HTTP 200 and awarded message
        And the account holder balance shown for trenette-acc-campaign is 7500
        And the account holder has a single pending reward for trenette-acc-campaign with count of 2, total cost to user of 25000, value of 10000 and total value of 20000 with conversation date 5 day in future
