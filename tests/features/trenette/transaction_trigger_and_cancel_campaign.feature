...
Feature: Bink BPL - Trigger transaction and cancel campaign while balance adjustments pending
    ...
    Background:
        ...
        And the trenette-draft-campaign campaign has an STAMPS earn rule with a threshold of 1000, an increment of 200, a multiplier of 1 and max amount of None
